 ...
 * Compatible with private_matching_orderbook_v1.aleo
 */

export const config = {
  // Deployed contract program ID (v1)
  CONTRACT_PROGRAM_ID: 'private_matching_orderbook_v1.aleo',
  ...
  // Contract constants (must match private_matching_orderbook_v1.aleo)
